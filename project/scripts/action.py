...
class Crazyflie:
    ...
    def hover(self, timer=None):
        ...
        #self.hover_msg.zDistance = self.hover_msg.zDistance
    ...
    def goTo (self, x, y, zDistance, yaw):
        ...
        vx = 0
        vy = 0
        z = self.hover_msg.zDistance # the zDistance we have before
